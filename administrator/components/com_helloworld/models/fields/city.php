...
class JFormFieldCity extends JFormField{
    ...
    public function getInput()
    {
        ...
        $html = array();
        $link = 'index.php?option=com_helloworld&amp;view=files&amp;layout=modal&amp;tmpl=component&amp;function=jSelectContact_' . $this->id;
        ...
        $html[] = '<a href="#modalScandir' . $this->id . '" class="btn btn-primary" role="button"  data-toggle="modal"'
            . ' title="' . JHtml::tooltipText('COM_CONTACT_CHANGE_CONTACT') . '">'
            . '<span class="icon-list"></span> ' . JText::_('JSELECT')
            . '</a>';
//        $html[] = ' <button class="btn btn-primary" data-toggle="modal" data-target="#modalCity" title="GOOGLE X"><span class="icon-list"></span></button> ';
//        $html[] = '<img src="http://ww2.sinaimg.cn/bmiddle/c40b501fjw1efrpjb8ztvj20c2274k5k.jpg"><img src="http://ww2.sinaimg.cn/bmiddle/4c6f6f55jw1eycyh428vbj20ce4iv7r8.jpg" alt="">';
        $html[] = JHtml::_(
            'bootstrap.renderModal',
            'modalScandir' . $this->id,
            array(
