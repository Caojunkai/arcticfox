...
$isShowPictureGrid = $params->get('is-picturegrid-show');//是否展示栅格图
$pictureGridRow    = $params->get('row-picturegrid-num');//展示行数
$pictureGridCol    = $params->get('col-picturegrid-num');//每行的列数
for($i = 1; $i <= $pictureGridRow*$pictureGridCol; $i++){
	$pictureUrl[] = $params->get('picturefrid-'.$i);
}
var_dump($pictureUrl);die;
...
<!--导航栏-->
		...
		<?php if($isShowPictureGrid) : ?>
			...
			<div class="row ">
				...
				<div class="col-md-3">
					<img src="http://pic.qiantucdn.com/images/slideshow/5603cdc98c33a.jpg" class="img-responsive img-thumbnail" alt="">
				</div>
				<div class="col-md-3">
					<img src="<?php echo $pictureUrl[0] ?>" class="img-responsive img-thumbnail">
				</div>
				<div class="col-md-3">
					<img src="http://pic.qiantucdn.com/58pic/18/17/66/19k58PIC3K5_1024.jpg" class="img-responsive img-thumbnail" alt="">
				</div>
				<div class="col-md-3">
					<img src="http://pic.qiantucdn.com/58pic/18/03/78/56M58PICqnC_1024.jpg" alt="" class="img-responsive img-thumbnail">
				</div>
			</div>
